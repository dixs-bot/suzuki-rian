...
export default function AboutSection() {
  ...
  const calculateDistance = () => {
    ...
    navigator.geolocation.getCurrentPosition(
      ...
      () => {
        setDistanceInfo("Tidak dapat mengakses lokasi Anda. Dealer beralamat di Jl. A. Yani No.259, Cihapit, Bandung.");
        setLoadingLocation(false);
      }
    );
  };
  ...
  return (
    <>
      <section id="tentang" className="section">
        <div className="container text-center reveal" style={{ marginBottom: "28px" }}>
          <h2 className="section-title">
            Tentang <span className="title-accent">Kami</span>
          </h2>
          <p className="section-subtitle">
            {siteConfig.dealerName} – Solusi Pembelian Mobil Suzuki Terbaik di Bandung &amp; Cimahi
          </p>
        </div>
        ...
        <div className="container about-grid">
          <div className="about-image-wrap reveal">
            <div className="sales-photo-wrap">
              <img
                ...
                alt={`${siteConfig.salesName} – Sales Consultant Suzuki Bandung & Cimahi di Dealer NJS Ahmad Yani`}
          ...
          <div className="about-text reveal">
            ...
            <p>
              Dengan pengalaman melayani ratusan pelanggan di Bandung Raya, Cimahi, dan Jawa Barat, saya berkomitmen memberikan solusi terbaik untuk kebutuhan kendaraan pribadi maupun niaga Anda bersama Suzuki Nusantara Jaya Sentosa Ahmad Yani.
            </p>
